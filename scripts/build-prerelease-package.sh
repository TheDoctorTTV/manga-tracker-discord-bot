...
GH_REPO="${GH_REPO:-}"
RELEASE_NOTES="${RELEASE_NOTES:-Automated draft prerelease generated by scripts/build-prerelease-package.sh}"
...
RELEASE_TAG="${RELEASE_TAG:-v$(cd "$ROOT_DIR" && node -e "console.log(require('./version.json').version)")}"
